...
export async function getUserKnowledgeBases() {
	...
	try {
		...
		if (response.data && Array.isArray(response.data.knowledge_bases)) {
			console.log(
				'Successfully fetched owned knowledge bases:',
				response.data.knowledge_bases.length
			);
			...
			throw new Error(
				`Failed to fetch owned knowledge bases: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
...
export async function getSharedKnowledgeBases() {
	...
	try {
		...
		if (response.data && Array.isArray(response.data.knowledge_bases)) {
			console.log(
				'Successfully fetched shared knowledge bases:',
				response.data.knowledge_bases.length
			);
			return response.data.knowledge_bases;
		} else {
			...
			const detail =
				response.data?.detail || response.data?.message || JSON.stringify(response.data);
			throw new Error(
				`Failed to fetch shared knowledge bases: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
	...
	try {
		...
		if (response.data && (response.data.kb_id || response.data.status === 'success')) {
			...
			const detail =
				response.data?.detail || response.data?.message || JSON.stringify(response.data);
			throw new Error(
				`Failed to create knowledge base: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
	...
	try {
		...
		if (response.data && response.data.id) {
			...
			const detail =
				response.data?.detail || response.data?.message || JSON.stringify(response.data);
			throw new Error(
				`Failed to fetch knowledge base details: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
	...
	try {
		...
		if (response.data && response.data.plugins && Array.isArray(response.data.plugins)) {
			...
			const detail =
				response.data?.detail || response.data?.message || JSON.stringify(response.data);
			throw new Error(
				`Failed to fetch ingestion plugins: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
	...
	try {
		...
		if (response.data && response.data.plugins && Array.isArray(response.data.plugins)) {
			...
			const detail =
				response.data?.detail || response.data?.message || JSON.stringify(response.data);
			throw new Error(
				`Failed to fetch query plugins: Invalid response format. Received: ${detail}`
			);
		}
	} catch (error) {
